...
@section('content')
    ...
    <div class="section">
        ...
        @if(isset($aboutEnglishData->cover_image))

        <img src="{{asset('/uploads/page/'.$aboutEnglishData->cover_image)}}" alt="">
        @endif
        </div>
        <!-- article img -->
        ...
        <!-- article title -->
        <h2 class="article-title">Our Introduction</h2>
        <!-- /article title -->

        <!-- article meta -->
        <ul class="article-meta">
        @if(isset($aboutEnglishData->created_at))

        <li>{{date('F j, Y,', strtotime($aboutEnglishData->created_at))}}</li>
        @endif
        </ul>
        <!-- /article meta -->
        @if(isset($aboutEnglishData->details))
        <p>{!! $aboutEnglishData->details !!}</p>
        @endif
        </div>
        <!-- /article content -->
