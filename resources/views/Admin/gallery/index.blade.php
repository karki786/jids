@extends('layout')
@section('title') List of Gallery @endsection
@section('content')
        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <ul class="icons-list pull-right">
                    <li>
                        <a class="btn btn-success" href="{{URL::to('system/gallery/create')}}"><i
            ...
            <div class="content-display clearfix">
                <div class="panel panel-default">
                    <div class="panel-heading no-bdr">
                        <div class="row">
                            <div class="col-sm-6">
                                {!!Form::open(['method'=>'GET','url'=>'system/gallery', 'class'=>'form-inline'])!!}
                ...
                @else
                    ...
                    @foreach($datas as $datum)
                        ...
                        <tr>
                            ...
                            @if($datum->image)
                                <td>
                                    <img src="{{ asset('uploads/gallery/'.$datum->image) }}"
