...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">{{(' Edit About Nepali management')}}</li>
    </ol>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::model($data,['method'=>'PUT','url'=>'system/aboutNepali/update/'.$data->id, 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a class="btn btn-default" href="{{URL::to('system/aboutNepali')}}"><i
