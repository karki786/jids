...
@section('title', ('Add About English management'))

@section('content')
    <ol class="breadcrumb">
        <li><a href="#">{{('Home')}}</a></li>
        <li><a href="#" >{{('About English management')}}</a></li>
        <li class="active">{{(' Add About English management')}}</li>
    </ol>

    <div id="page-title">
        <h2 style="display:inline-block">{{('About English management')}}</h2>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::open(['method'=>'post','url'=>'system/aboutEnglish/store', 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a class="btn btn-default" href="{{URL::to('/system/aboutEnglish')}}"><i class="glyphicon glyphicon-chevron-left" style="margin-right:10px;"></i>{{('Back')}}</a>
