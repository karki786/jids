        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <ul class="icons-list pull-right">
                    <li>
                        <a class="btn btn-success" href="{{URL::to('system/aboutNepali/create')}}"><i
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-info btn_glyph"
                                   href="{{URL::to('system/aboutNepali/edit/'.$datum->id)}}"><i
                                            class="glyphicon glyphicon-edit"></i> {{('Edit')}}</a>
                                <a class="btn btn-sm btn-danger btn_glyph" onclick="return confirm(' you want to delete?');"
                                   href="{{URL::to('system/aboutNepali/delete/'.$datum->id)}}"><i
