...
@section('title', ('Edit Committee English management'))

@section('content')
    <ol class="breadcrumb">
        <li><a href="#">{{('Home')}}</a></li>
        <li><a href="#" >{{('Committee English management')}}</a></li>
        <li class="active">{{(' Edit Committee English management')}}</li>
    </ol>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::model($data,['method'=>'PUT','url'=>'system/committeeEnglish/update/'.$data->id, 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a class="btn btn-default" href="{{URL::to('system/committeeEnglish')}}"><i
