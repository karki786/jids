...
@section('content')
    <ol class="breadcrumb">
        <li><a href="#">{{('Home')}}</a></li>
        <li><a href="#" >{{('committee Nepali management')}}</a></li>
        <li class="active">{{(' Edit committee Nepali management')}}</li>
    </ol>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::model($data,['method'=>'PUT','url'=>'system/committeeNepali/update/'.$data->id, 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a class="btn btn-default" href="{{URL::to('system/committeeNepali')}}"><i
