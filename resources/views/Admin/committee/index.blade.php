...
@section('content')
    ...
    <div class="panel panel-flat border-top-info">
            ...
            @if($datas->count()==0)
                <div class="row">
                    <ul class="icons-list pull-right">
                        <li>
                            <a class="btn btn-success" href="{{URL::to('system/committeeEnglish/create')}}"><i
        ...
        <div class="panel-body">
            ...
            {{--<div class="row">--}}
            {{--<div class="col-sm-6">--}}
            {{--{!!Form::open(['method'=>'GET','url'=>'system/page', 'class'=>'form-inline'])!!}--}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-info btn_glyph"
                                   href="{{URL::to('system/committeeEnglish/edit/'.$datum->id)}}"><i
                                            class="glyphicon glyphicon-edit"></i> {{('Edit')}}</a>
                                <a class="btn btn-sm btn-danger btn_glyph" onclick="return confirm(' you want to delete?');"
                                   href="{{URL::to('system/committeeEnglish/delete/'.$datum->id)}}"><i
