...
@section('title', ('Edit Header Image  management'))

@section('content')
    <ol class="breadcrumb">
        <li><a href="#">{{('Home')}}</a></li>
        <li><a href="#" >{{('Header Image  management')}}</a></li>
        <li class="active">{{(' Edit Header Image  management')}}</li>
    </ol>

    <div id="page-title">
        <h2 style="display:inline-block">{{('Header Image  management')}}</h2>
    </div>

    @include('errors/error')
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::model($data,['method'=>'PUT','url'=>'system/headerImage/update/'.$data->id, 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
            ...
            <div class="form-group ">
                ...
                <div class="form-group">
                    <div class="col-sm-9">
                        @if($data->cover_image)
                            <img src="{{asset('/uploads/headerImage/'.$data->cover_image)}}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <a class="btn btn-default" href="{{URL::to('system/headerImage')}}"><i
