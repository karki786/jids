        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <ul class="icons-list pull-right">
                    <li>
                        <a class="btn btn-success" href="{{URL::to('system/headerImage/create')}}"><i
            ...
            <div class="content-display clearfix">
                <div class="panel panel-default">
                    <div class="panel-heading no-bdr">
                        <div class="row">
                            <div class="col-sm-6">
                                {!!Form::open(['method'=>'GET','url'=>'system/headerImage', 'class'=>'form-inline'])!!}
            ...
            <table class="table table-hover">
                ...
                @else
                    ...
                    @foreach($datas as $datum)
                        ...
                        <tr>
                            <td>{{ $a }}</td>
                            @if($datum->cover_image)
                                <td>
                                    <img src="{{ asset('uploads/headerImage/'.$datum->cover_image) }}"
                                         alt="{{ $datum->title }}" width="85">
                                </td>
                            @else <td></td> @endif
                            <td>{{$datum->title}}</td>
                            <td>{!!  $datum->slug!!}</td>
                            <td>
                                ...
                                <a class="btn btn-sm btn-info btn_glyph"
                                   href="{{URL::to('system/headerImage/edit/'.$datum->id)}}"><i
                                            class="glyphicon glyphicon-edit"></i> {{('Edit')}}</a>
                                <a class="btn btn-sm btn-danger btn_glyph" onclick="return confirm(' you want to delete?');"
                                   href="{{URL::to('system/headerImage/delete/'.$datum->id)}}"><i
