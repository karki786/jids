...
@section('title', ('Add Upcoming Project'))

@section('content')
    <ol class="breadcrumb">
        <li><a href="#">{{('Home')}}</a></li>
        <li><a href="#" >{{('Upcoming Project')}}</a></li>
        <li class="active">{{(' Add Upcoming Project')}}</li>
    </ol>

    <div id="page-title">
        <h2 style="display:inline-block">{{('Upcoming Project')}}</h2>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            {!!Form::open(['method'=>'post','url'=>'system/project/store', 'class'=>'form-horizontal bordered-row','enctype'=>'multipart/form-data'])!!}
