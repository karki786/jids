...
$config = [
    ...
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']),
                ['off', 'no'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
    ...
    */
    ...
    |
    */
    'access_keys' => ['lB2PK8fl735R7xM849MA50UHFJXpID38'],
    ...
    */
    ...
    'previewable_text_file_exts' => ['txt', 'log', 'xml', 'html', 'css', 'htm', 'js'],
    ...
    //Video
    'ext_music' => ['mp3', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav'],
    //Audio
    ...
    */
    ...
    'relative_image_creation_width' => [900, 1000],
    //width of image (you can leave empty if you set height)
    'relative_image_creation_height' => [400, ''],
    //height of image (you can leave empty if you set width)
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
